...
import {CasesCreateComponent, CaseCreateSubmitComponent, CaseSharingComponent } from './containers';
...
export const ROUTES: Routes = [
    {
      ...
      children: [
        ...
        {
          path: 'case-sharing',
          component: CaseSharingComponent,
          canActivate: [ HealthCheckGuard ],
          data: {
            title: 'HMCTS Manage Cases | Case sharing'
          }
        }
      ]
    },
